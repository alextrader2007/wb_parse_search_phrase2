...
| **Экспорт** | Excel (.xlsx) + CSV (UTF-8-sig) с аварийным сохранением при сбое |
...
- **Лимиты**: парсер делает случайные паузы (0.3–1.5 сек) между запросами. При большом объёме данных используйте прокси.
